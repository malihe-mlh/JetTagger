# Using density=True for normalized probability density plot
# This makes distributions comparable regardless of total event count
...
# Plot stacked histogram با density=True
...
plt.tight_layout()
plt.savefig("THAD_score_stacked_density.png", dpi=300)
plt.show()
